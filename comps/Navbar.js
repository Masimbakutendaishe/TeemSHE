...
const subLinks = [
  ...
  [ // PRODUCTS & SERVICES
    ...
    },
    {
      ...
      sublinks: [
        { href: "/systems-development#engineering", label: "Engineering" },
        { href: "/systems-development#digital", label: "Digital Transformation" },
        { href: "/systems-development#energy", label: "Energy Efficiency" },
      ],
    },
    {
      label: "Security and Energy Solutions",
      href: "/security-energy",
      sublinks: [
        { href: "/security-energy#scheduled", label: "Scheduled" },
        { href: "/security-energy#remote", label: "Remote Support" },
        { href: "/security-energy#field", label: "Field Services" },
      ],
    },
    {
      ...
      sublinks: [
        { href: "/academic-projects#onboarding", label: "Onboarding" },
        { href: "/academic-projects#safety", label: "Safety" },
        { href: "/academic-projects#specialized", label: "Specialized" },
      ],
    },
  ],
  [ // TRAINING
    {
      ...
      sublinks: [
        { href: "/training-data-science#basics", label: "Basics" },
        { href: "/training-data-science#advanced", label: "Advanced" },
        { href: "/training-data-science#expert", label: "Expert" },
      ],
    },
    {
      label: "Electronics and Robotics",
      href: "/electronics-robotics",
      sublinks: [
        { href: "/electronics-robotics#tech", label: "Tech Certs" },
        { href: "/electronics-robotics#industry", label: "Industry Standards" },
        { href: "/electronics-robotics#global", label: "Global Certs" },
      ],
    },
    {
      label: "Technology for Kids",
      href: "/technology-kids",
      sublinks: [
        { href: "/technology-kids#inperson", label: "In Person" },
        { href: "/technology-kids#online", label: "Online" },
        { href: "/technology-kids#live", label: "Live Demos" },
      ],
    },
  ],
];
