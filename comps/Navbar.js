...
const subLinks = [
  ...
  [ // PRODUCTS & SERVICES
    ...
    },
    {
      ...
      href: "/SystemsDevelopmentPage",
      sublinks: [
        { href: "/SystemsDevelopmentPage#engineering", label: "Engineering" },
        { href: "/SystemsDevelopmentPage#digital", label: "Digital Transformation" },
        { href: "/SystemsDevelopmentPage#energy", label: "Energy Efficiency" },
      ],
    },
    {
      label: "Security and Energy Solutions",
      href: "/SecurityEnergyPage",
      sublinks: [
        { href: "/SecurityEnergyPage#scheduled", label: "Scheduled" },
        { href: "/SecurityEnergyPage#remote", label: "Remote Support" },
        { href: "/SecurityEnergyPage#field", label: "Field Services" },
      ],
    },
    {
      label: "Academic Projects",
      href: "/AcademicProjectsPage",
      sublinks: [
        { href: "/AcademicProjectsPage#onboarding", label: "Onboarding" },
        { href: "/AcademicProjectsPage#safety", label: "Safety" },
        { href: "/AcademicProjectsPage#specialized", label: "Specialized" },
      ],
    },
  ],
  [ // TRAINING
    {
      ...
      href: "/AITrainingPage",
      sublinks: [
        { href: "/AITrainingPage#basics", label: "Basics" },
        { href: "/AITrainingPage#advanced", label: "Advanced" },
        { href: "/AITrainingPage#expert", label: "Expert" },
      ],
    },
    {
      label: "Electronics and Robotics",
      href: "/ElectronicsRoboticsPage",
      sublinks: [
        { href: "/ElectronicsRoboticsPage#tech", label: "Tech Certs" },
        { href: "/ElectronicsRoboticsPage#industry", label: "Industry Standards" },
        { href: "/ElectronicsRoboticsPage#global", label: "Global Certs" },
      ],
    },
    {
      label: "Technology for Kids",
      href: "/KidsTechnologyPage",
      sublinks: [
        { href: "/KidsTechnologyPage#inperson", label: "In Person" },
        { href: "/KidsTechnologyPage#online", label: "Online" },
        { href: "/KidsTechnologyPage#live", label: "Live Demos" },
      ],
    },
  ],
];
